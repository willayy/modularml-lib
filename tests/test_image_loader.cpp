...
TEST(test_image_loader, load_mnist_image_jpg_test) {
  ...
  EXPECT_EQ(array_mml({static_cast<unsigned long int>(1),
                       static_cast<unsigned long int>(1),
                       static_cast<unsigned long int>(28),
                       static_cast<unsigned long int>(28)}),
...
TEST(test_image_loader, load_rgb_image_png_test) {
  ...
  EXPECT_EQ(array_mml({static_cast<unsigned long int>(1),
                       static_cast<unsigned long int>(3),
                       static_cast<unsigned long int>(100),
                       static_cast<unsigned long int>(100)}),
            image_tensor->get_shape());
}
...
TEST(test_image_loader, load_jpeg_image) {
  ...
  EXPECT_EQ(array_mml({static_cast<unsigned long int>(1),
                       static_cast<unsigned long int>(3),
                       static_cast<unsigned long int>(375),
                       static_cast<unsigned long int>(500)}),
            image_tensor->get_shape());
}